  ...
  LGFX(void) {
    {
      ...
      // Official Elecrow ST7262 panel clock
      cfg.freq_write = 16000000;

      // Factory horizontal timings (total 848 clocks)
      cfg.hsync_polarity = 0;
      cfg.hsync_front_porch = 8;
      cfg.hsync_pulse_width = 4;
      cfg.hsync_back_porch = 36;

      // Factory vertical timings (total 498 lines -> ~38 Hz refresh lock)
